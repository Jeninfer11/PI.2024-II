...
class AuthServices {
  ...
  Future<Resource<AuthResponse>> reserva(Reserva reserva) async {
    try {
      Uri url = Uri.http(ApiConfig.API_ECOMMERCE, '/client/reserva');
      Map<String, String> headers = {"Content-Type": "application/json"};
      String body = json.encode(reserva);
  ...
  Future<Resource<AuthResponse>> pago(Pago pago) async {
    try {
      Uri url = Uri.http(ApiConfig.API_ECOMMERCE, '/client/pago');
      Map<String, String> headers = {"Content-Type": "application/json"};
      String body = json.encode(servicio);
